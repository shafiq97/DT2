            ...
            <div id="content">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="update_user_form.php">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold">You have <?php echo $_SESSION['current_count']?> user(s) with no role</span>
                                    </div>
                                </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h1 mb-0 text-black-800">Make an announcement</h1>
                    </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <form method="post">
                                    <div class="collapse show" id="collapseCardExample">
                                        ...
                                        <button type="submit" class="form-control btn-primary uia" name='announceBtn'>Announce</button>
                                    </div>
                                </form>
                                <?php
