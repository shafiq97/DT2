                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <a href="#collapseCardExample" class="d-block card-header py-3 blue" data-toggle="collapse"
                                        ...
                                        <h6 class="font-weight-bold text-white px-4">Add Meeting:<span> * Required Fill </span></h6>
                                    </a>
                                    <!-- Card Content - Collapse -->
                                    <div class="collapse show" id="collapseCardExample">
                                        <div class="form-group px-5 pt-2">
                                            <label for="meeting_name">Meeting Name *</label>
                                            <input type="text" class="form-control" id="meeting_name" name="meeting_name" required autocomplete="off">
                                        </div>
                                        <div class="form-group px-5 pt-2">
