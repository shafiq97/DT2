...
<body id="page-top">
                                    ...
                                    <div class="collapse show" id="collapseCardExample">
                                        ...
                                        <div class="form-group px-5 pt-2">
                                            ...
                                            <?php
                                                ...
                                                echo "<option value=''>Please Select</option>";
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<option value='".$row['graduate_level_code']."'> ".$row['graduate_level_type']." Level: ". $row['graduate_level']."</option>";
                                                }
                                            ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group px-5 pt-2">
                                            ...
                                            <input type="date" step="1" class="form-control" id="meeting_date" name="meeting_date" required>
                                        </div>

                                        <!-- Deadline Submission -->
                                        <div class="form-group px-5 pt-2">
                                            <label for="dateline_submission">Deadline of Submission *</label>
                                            <input type="date" step="1" class="form-control" id="deadline_submission" name="deadline_submission" required>
                                        </div>
                                        ...
                                        <div class="form-group px-5 pt-2">
                                            ...
                                            <input type="text" class="form-control" id="mqa" name="mqa" autocomplete="off">
                                        </div>

                                        <div class="form-group px-5 pt-2">
                                            <label for="doc_name">Title of Document *</label>
                                            <textarea type="text" style="height: 100px;" class="form-control" id="doc_name" name="doc_name" required autocomplete="off"></textarea>
                                        </div>
                                        ...
                                        <div class="form-group px-5 pt-2">
                                            ...
                                            <input type="date" step="1" class="form-control" id="date_receive" name="date_receive" required>
                                        </div>

                                        <!-- Assigned To -->
                                        <div class="form-group px-5 pt-2">
                                            <label for="owner">Assigned to *</label><br>
                                            <?php
                                                $query = "SELECT * FROM users WHERE role_name = 'owner'";
                                                $result = mysqli_query($conn,$query);
                                        ...
                                        <div class="form-group px-5 pt-2">
                                            ...
                                            <input type="date" step="1" class="form-control" id="date_assign" name="date_assign">
                                        </div>
                                        ...
                                        <!-- Receive from 2 -->
                                        <div class="form-group px-5 pt-2">
                                            <label for="owner">Received from 2 *</label><br>
                                            <?php 
                                                $query = "SELECT * FROM users WHERE role_name = 'owner'";
                                                $result = mysqli_query($conn,$query);
                                                echo"<select class='form-control' name='receive_from'>";
                                                echo"<option value=''> Please Select</option>";
                                                while ($row = mysqli_fetch_array($result)) 
                                                {
                                                    echo"<option value='".$row['name']."'> ".$row['name']."</option>";  
                                         ...
                                         <!-- Date Received Amended proposal from Centre of Studies -->
                                         <div class="form-group px-5 pt-2">
                                            <label for="receive_date">Date Assigned *</label>
                                            <input type="date" step="1" class="form-control" id="date_assign" name="date_assign">
                                        </div>
                                        ...
                                        <!-- Assigned To 2-->
                                        <div class="form-group px-5 pt-2">
                                            <label for="owner">Assigned to 2*</label><br>
                                            <?php
                                                $query = "SELECT * FROM users WHERE role_name = 'owner'";
                                                $result = mysqli_query($conn,$query);
                                        ...
                                        <!-- Date Assigned 2-->
                                        <div class="form-group px-5 pt-2">
                                            <label for="receive_date">Date Assigned 2*</label>
                                            <input type="date" step="1" class="form-control" id="date_assign" name="date_assign">
                                        </div>

                                        <!-- Receive approval from Assignee -->
                                        <div class="form-group px-5 pt-2">
                                            <label for="owner">Received  Approval from Assignee (2)*</label><br>
                                            <?php 
                                                $query = "SELECT * FROM users WHERE role_name = 'owner'";
                                                $result = mysqli_query($conn,$query);
                                                echo"<select class='form-control' name='receive_from'>";
                                        ...
                                        <!-- Status -->
                                        <div class="form-group px-5 pt-2">
                                            <label for="doc_comment">Status</label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#mqf_level').change(function(){
                // var mqf_level = $('#mqf_level').val();
                // $("#mqf_level:text").val(mqf_level);
                alert("HAHA");
            })
