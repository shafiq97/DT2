                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="collapse show" id="collapseCardExample">
                                        ...
                                        <div class="form-group px-5 pt-2">
                                            ...
                                            <select name="kuliyyah" class="form-control" id="cos">
                                            <?php
                                        ...
                                        <div class="form-group px-5 pt-2">
                                            ...
                                            <?php
                                                ...
                                                echo "<option>Please Select</option>";
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<option value='".$row['code_type']."'> ".$row['type']."</option>";
                                                }
                                            ?>
                                            </select>
                                        </div>
                                        ...
                                        <!-- Dateline Submission -->
                                        <div class="form-group px-5 pt-2">
                                            <label for="dateline_submission">Dateline of Submission *</label>
                                            <input type="datetime-local" step="1" class="form-control" id="dateline_submission" name="dateline_submission" required>
                                        </div>
                                        <!-- Category Documents -->
                                        <div class="form-group px-5 pt-2">
                                            <label for="category_documents">Category of documents</label>
                                            <select  name="category_documents" class="form-control">
                                            <?php
