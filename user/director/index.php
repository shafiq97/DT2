...
<body id="page-top">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto black">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="indexmain.php">
                                    <div class="mr-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"> Director Dashboard</h1>
                    </div>
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo "<tr>";
                                                    echo "<form method='post' id='track' target='_blank' action='track.php'>";
                                                    ...
                                                    if (filter_var($row['doc_location'], FILTER_VALIDATE_URL) === FALSE) {
                                                        echo"<td><button class='btn btn-danger' name='link_error' form = 'track' value='".$row['doc_location']."'>View</button></td>";
                                                    }
                                                    else{
                                                    ...
                                                    echo "<td><button class='btn btn-dark' type='submit' form='track' name='trackBtn' value='".$row['id']."'>Track</button>
                                                            </td>";
    ...
    if (isset($_POST['update_btn'])) {
      if (empty($_POST['doc_name'])) {
        ...
        $description    = $_POST['doc_desc']; //can be doc type
        ...
        if($responsibility != $_SESSION['name']){
            $status = "Pending";
        }
        else{
            $query = "SELECT doc_status FROM documents WHERE `id` = '$id'";
            $result = mysqli_query($conn, $query);
            while($row = mysqli_fetch_array($result)){
                if($row['doc_status'] != $_POST['status']){
                    $status = $_POST['status'];
                } 
            }
        }
    ...
    //echo "<br><a href=../director/>Menu</a>";
