                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                <option value='Others'>Others</option>
                                                                        ...
                                                                        <div class='modal-footer'>";
                                                                            if($currentName === $row['doc_responsibility'])
                                                                                {
                                                                                    echo"<button type='submit' class='btn btn-default' name='update_btn'>Update</button>";
                                                                                }
                                                                                else
                                                                                {
                                                                                    echo"<button type='submit' class='btn btn-default' name='update_btn' disabled>Update</button>";
                                                                                }
